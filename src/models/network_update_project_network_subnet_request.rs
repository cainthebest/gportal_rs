...
pub struct NetworkUpdateProjectNetworkSubnetRequest {
...
impl NetworkUpdateProjectNetworkSubnetRequest {
    pub fn new() -> NetworkUpdateProjectNetworkSubnetRequest {
        NetworkUpdateProjectNetworkSubnetRequest {
            project_id: None,
            id: None,
            cidr: None,
            pool_start: None,
