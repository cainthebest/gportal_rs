...
pub struct PaymentCreateBillingAddressRequest {
...
impl PaymentCreateBillingAddressRequest {
    pub fn new() -> PaymentCreateBillingAddressRequest {
        PaymentCreateBillingAddressRequest {
            company: None,
            name: None,
            vat_id: None,
            country_code: None,
